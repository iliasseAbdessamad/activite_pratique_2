...
@Configuration
public class HydrateH2DatabaseConfig {

    ProductRepository productRepository;

    public HydrateH2DatabaseConfig(ProductRepository productRepository){
        this.productRepository = productRepository;
    }

    @Bean
    public CommandLineRunner hydrateData(ProductRepository productRepository){
        return args -> {
            try{
                //Hydrating data
